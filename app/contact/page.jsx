        ...
        <div className="max-w-[100rem] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <address className="text-gray-700 text-base not-italic group-hover:text-accent transition-colors">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            >
              <div className="bg-dark p-8 shadow-md rounded-sm">
                <h3 className="text-2xl font-xoireqe uppercase text-white mb-2">
                  Send Us a Message
                </h3>
                <p className="text-white/80 mb-4">Reach out today to contact us about a free estimate for your project.</p>
                <div className="h-1 w-16 bg-primary mb-8"></div>
                
                {submitSuccess ? (
                  <div className="text-white text-center p-8" aria-live="polite">
                  ...
                  <form onSubmit={handleSubmit} noValidate>
                    ...
                    {submitError && (
                      <div className="p-3 mb-6 bg-yellow-500/20 border border-yellow-300 text-white rounded-sm" aria-live="assertive" role="alert">
                    ...
                    <button
                      ...
                      className={`w-full bg-accent hover:bg-accent/90 focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-dark focus:outline-none
